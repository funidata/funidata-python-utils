...
@pytest.mark.asyncio
async def test_recursive_import_batching_with_sublists_on_no_fails(mock_client):
    test_data = [
        [
            {
                "id": 2,
...
@pytest.mark.asyncio
async def test_recursive_import_batching_with_sublists_on_one_fail(mock_client):
    test_data = [
        [
            {
                "id": 2,
...
@pytest.mark.asyncio
async def test_recursive_import_batching_with_sublists_on_multiple_fails(mock_client):
    test_data = [
        [
            {
                "id": 2,
...
@pytest.mark.asyncio
async def test_recursive_import_batching_with_sublists_on_all_fails(mock_client):
    test_data = [
        [
            {
                "id": 2,
...
@pytest.mark.asyncio
async def test_recursive_import_batching_with_sublists_on_all_exceptions(mock_client):
    test_data = [
        [
            {
                "id": 2,
...
@pytest.mark.asyncio
async def test_recursive_import_batching_with_sublists_on_all_exceptions_limited_max_depth(mock_client):
    test_data = [
        [
            {
                "id": 2,
